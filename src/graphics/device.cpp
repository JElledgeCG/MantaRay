...
void Device::init(VkInstance* instancePtr, VkSurfaceKHR* surfacePtr) {
	instanceHandle = instancePtr;
	surfaceHandle = surfacePtr;
...
QueueFamilyIndices Device::findQueueFamilies(VkPhysicalDevice device) {
	...
	for (const auto& queueFamily : queueFamilies) {
		...
		vkGetPhysicalDeviceSurfaceSupportKHR(device, i, *surfaceHandle, &presentSupport);
